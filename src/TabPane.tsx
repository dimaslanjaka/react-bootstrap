...
const TabPane: BsPrefixRefForwardingComponent<'div', TabPaneProps> = React.forwardRef<HTMLElement, TabPaneProps>(
    ...
    return (
      <TabContext.Provider value={null}>
        <SelectableContext.Provider value={null}>
          ...
          >
            <Component {...rest} ref={ref} className={classNames(className, prefix, isActive && 'active')} />
          </Transition>
