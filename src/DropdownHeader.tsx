...
const DropdownHeader: BsPrefixRefForwardingComponent<'div', DropdownHeaderProps> = React.forwardRef<
  HTMLElement,
  DropdownHeaderProps
>(({ className, bsPrefix, as: Component = 'div', role = 'heading', ...props }, ref) => {
